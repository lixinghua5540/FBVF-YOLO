...
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, max_size=3000, max_subplots=16):
    ...
    if fname:
        ...
        Image.fromarray(mosaic).save(fname, dpi=(300.0,300.0))  # PIL save
    return mosaic

def plot_images_v5(images, targets, paths=None, fname="images.jpg", names=None):
...
def plot_labels(labels, names=(), save_dir=Path("")):
    ...
    plt.savefig(save_dir / "labels_correlogram.jpg", dpi=600)
    plt.close()
    ...
    plt.savefig(save_dir / "labels.jpg", dpi=600)
    matplotlib.use("Agg")
    plt.close()
